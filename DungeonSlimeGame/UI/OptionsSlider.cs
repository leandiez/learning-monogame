...
public class OptionsSlider : Slider
{
    ...
    public OptionsSlider(TextureAtlas atlas)
    {
        ...
        offBackground.TextureLeft = offBackgroundRegion.Region.Left;
        offBackground.TextureTop = offBackgroundRegion.Region.Top;
        ...
        middleBackground.TextureLeft = middleBackgroundRegion.Region.Left;
        middleBackground.TextureTop = middleBackgroundRegion.Region.Top;
        ...
        maxBackground.TextureLeft = maxBackgroundRegion.Region.Left;
        maxBackground.TextureTop = maxBackgroundRegion.Region.Top;
