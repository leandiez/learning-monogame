...
public class TitleScene : Scene {
    ...
    public override void Initialize()
    {
        ...
        //Usa la propiedad estatica de Core, por eso es dependencia en using.
        ...
        // Initialize the offset of the background pattern at zero and set his rectangle to all the Screen.
    ...
    public override void LoadContent()
    {
        ...
        _font5x = Content.Load<SpriteFont>("fonts/04B_30x");
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        // Draw the background pattern first using the PointWrap sampler state to repeat the texture and PointFilter.
        // Para que se mueva se cambia el offset en Update. NO se mueve la posicion sino el borde superior izquierdo de la textura y se wrapea.
