...
public class Tileset
{
    ...
    public Tileset(TextureRegion textureRegion, int tileWidth, int tileHeight) // Podria ser un Texture2D 
    {
        TileWidth = tileWidth;
        ...
        for (int i = 0; i < Count; i++)
        {
            ...
            _tiles[i] = new TextureRegion(textureRegion.Texture, textureRegion.Region.X + x, textureRegion.Region.Y + y, tileWidth, tileHeight);
        }
    }    
