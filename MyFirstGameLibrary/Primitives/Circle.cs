namespace MyFirstGameLibrary.Primitives;

using System;
using Microsoft.Xna.Framework;
// Elemento para modelar un collider en forma de Circulo.
public readonly struct Circle : IEquatable<Circle> 
{
    private static readonly Circle SEmpty = new Circle();
    /// <summary>
    ...
    /// </summary>
    public static Circle Empty => SEmpty;
